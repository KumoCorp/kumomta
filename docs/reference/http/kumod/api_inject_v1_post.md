...
This is an object value, with the following properties:
  ...
  * `content` - required [Content](schemas/Content.md). Specifies the message content. It can either be a string value or
  ...
  * `recipients` - required array of [Recipient](schemas/Recipient.md). Specifies the list of recipients to which message(s) will be sent.
  ...
  * `template_dialect` - optional [TemplateDialectWithSchema](schemas/TemplateDialectWithSchema.md). {{since('2025.12.02-67ee9e96', inline=True)}}
  ...
  * `trace_headers` - optional [HttpTraceHeaders](schemas/HttpTraceHeaders.md). {{since('2024.11.08-d383b033', inline=True)}}
