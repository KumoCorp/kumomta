...
Set this to `false` to disable splice and use regular userspace copying
instead.  This may be useful for debugging or if you encounter issues with
splice on your system.

The default is `true` (splice is enabled on Linux).
