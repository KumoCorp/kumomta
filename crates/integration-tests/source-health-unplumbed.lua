-- Source with an unplumbed local bind address (`9.9.9.9`) and an
-- Immediate `suspend_when_unplumbed` rule. A single failed connect
-- attempt should auto-suspend the source for the configured duration.
