...
kumo.on('init', function()
  ...
  -- Map proxy.test to TWO addresses: an unreachable one first, then a
  -- reachable one. This exercises the multi-candidate failover path
  -- in EgressSource::connect_to: the first attempt should fail with
  -- a network error, the second should succeed.
